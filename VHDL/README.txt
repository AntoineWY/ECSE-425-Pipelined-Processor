...
3. If you want to run a entire program, please use the "pipeline-TCL.tcl" script. Use command "source pipeline-TCL.tcl" in modelSim command transcript will run the code.
